...
/**
 ...
 int main(void)
 {
     ...
     sw_i2c_init();                             // initialize I2C library

     // write 0x75 to EEPROM address 5 (Byte Write) 
     sw_i2c_start_wait(Dev24C02+I2C_WRITE);     // set device address and write mode
     sw_i2c_write(0x05);                        // write address = 5
     sw_i2c_write(0x75);                        // write value 0x75 to EEPROM
     sw_i2c_stop();                             // set stop conditon = release bus
     ...
     sw_i2c_write(0x05);                        // write address = 5
     sw_i2c_rep_start(Dev24C02+I2C_READ);       // set device address and read mode

     ret = sw_i2c_readNak();                    // read one byte from EEPROM
     sw_i2c_stop();
...
/** 
 ...
 Implemented as a macro, which calls either sw_i2c_readAck or sw_i2c_readNak
...
unsigned char sw_i2c2_readAck();
unsigned char sw_i2c2_readNak();
